...
if (db.readyState !== 1) {
  ...
  db.once("open", async () => {
    ...
    const defaultQAPairs = [
      {
        question: "How many schemes do you have?",
        answer:
          "We have 172 schemes in our database. You can select which one suits you.",
      },
      {
        question: "How many schemes do you have for females?",
        answer: "We have more than 6 schemes for females.",
      },
      {
        question: "What is the minimum age limit on your schemes?",
        answer: "The minimum age limit is 1 year.",
      },
    ];
